...
その時のアプリの実装では会社名で検索されても会社名に関係のない募集が出たりしていてユーザー体験が悪いものになってしまってると仮説が立てられました。

---

### 会社が検索結果に入るようになり、以前よりもユーザーが検索を利用すようになりました。
...
![inline 100%](screenshot_sample_buildings1.png)
...
- KPI(グロースを測るために一番追いたい数字)への貢献
- どれくらいの%で施策が影響を実際に与えたのかを見る

>KPIとして、ユーザーの継続率を追っていて、先週の継続率が32%だったのに対して施策後は、36%に増えた。最新バージョンを入れてる人で41%で現行バージョンを入れてる人で34%だったからこの施策は十分にKPIに貢献したと言えそう！。
